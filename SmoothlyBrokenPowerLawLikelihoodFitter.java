...
public class SmoothlyBrokenPowerLawLikelihoodFitter implements OptimizableFunction {
	...
	System.out.println("Least Squares (full dataset): \n alpha="+num.format(indexAndNorm[0])+"\t norm="+exp.format(indexAndNorm[1]));
	...
	System.out.println("Least Squares (low frequencies): \n alpha="+num.format(indexAndNorm[0])+"\t norm="+exp.format(indexAndNorm[1]));
	...
	System.out.println("Least Squares (high frequencies): \n alpha="+num.format(indexAndNorm[0])+"\t norm="+exp.format(indexAndNorm[1]));	
