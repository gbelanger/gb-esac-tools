...
public final class MinMax {
	...
	int dataInt[] = Converter.short2int(data);
	int max = -Integer.MAX_VALUE;
    ...
    public static double getMax(Vector dataVector) {
	double max = -Double.MAX_VALUE;
	double dataValue = 0;
	...
	return (new Integer(min)).shortValue();
    }
    ...
    public static double getMin(Vector dataVector) {
